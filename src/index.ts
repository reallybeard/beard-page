...
<title>Venice.ai - Scheduled Maintenance</title>
<style>
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .status {
    ...
    padding: 6px 14px;
    border-radius: 100px;
    background: rgba(14, 41, 66, 0.05);
    border: 1px solid rgba(14, 41, 66, 0.1);
    font-size: 0.75rem;
    font-weight: 500;
...
<div class="container">
  ...
  <p>We're performing an infrastructure upgrade to support Venice's rapid growth. The app and API will be temporarily unavailable.</p>
  <p class="window">2026-03-08 // 11:30&ndash;12:00 UTC</p>
